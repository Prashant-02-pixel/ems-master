                                      ...
                                      <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="leave-type" name="leave-type" >
                                                    ...
                                                    <option  value="RH">Half Day Leave</option>                                                    <option  value="CCL">Compensatory Leave</option>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="time-period" name="time-period">
                                                    ...
                                                    <option  value="After Noon">Morning</option>
                                                    <option  value="Fore Noon">AfterNoon</option>
                                                    </select>
                                            </div>
                                        </div>
                                        </div>
